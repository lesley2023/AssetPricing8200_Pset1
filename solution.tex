...
\begin{table}[htbp]
    \centering
    \caption{Time-series averages of bond excess log yields, forward rates, and annual returns}
    \label{tab:q4a_bond_averages}
    \begin{tabular}{cccc}
        \toprule
        $H$ & $\overline{xy}^{(H)}_b$ & $\overline{xf}^{(H)}_b$ & $\overline{xr}^{(H)}_b$ \\
        \midrule
        2 & 0.001686 & 0.003372 & 0.003349 \\
        3 & 0.003278 & 0.006461 & 0.006415 \\
        4 & 0.004660 & 0.008805 & 0.008734 \\
        5 & 0.005639 & 0.009557 & 0.009457 \\
        \bottomrule
    \end{tabular}
\end{table}
