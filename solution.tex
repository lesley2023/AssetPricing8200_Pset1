...
So estimating the VAR by OLS really means estimating three regressions:

\[
\Delta d_{t+1} = a_1 + \gamma_{11}\Delta d_t + \gamma_{12}r_{e,t} + \gamma_{13}dp_t + \epsilon_{1,t+1},
\]

\[r_{e,t+1}= a_2 + \gamma_{21}\Delta d_t + \gamma_{22}r_{e,t} + \gamma_{23}dp_t + \epsilon_{2,t+1},\]

and
\[dp_{t+1}= a_3 + \gamma_{31}\Delta d_t + \gamma_{32}r_{e,t} + \gamma_{33}dp_t + \epsilon_{3,t+1}.\]
