...
The estimated spectral radius is $\rho(\kappa\Gamma)=0.837603<1$, so the
stability condition for the long-run limit is satisfied. The resulting
long-run VAR-implied coefficients are reported in Table~\ref{tab:q1d_long_run}.
